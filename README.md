...
* "index.js" which acts as an entrypoint for the NodeJS application
...
Next, we will create an image of this applciation through ECR and ECS.

Lets push the image of this application through ECR by creating a repo named "nodejs-app".
